  ...
  return (
    <section className='relative py-16 md:py-24 px-6 overflow-hidden'>
      <div className='container mx-auto'>
        ...
        <div className='relative p-16 md:p-32 mx-auto w-fit border-2 border-gray-700 bg-gray-500  bg-opacity-20 rounded-3xl'>
            <img 
            ...
            />
          <h1 className='font-bold font-space-grotesk tracking-tight text-5xl sm:text-8xl'>Start your <br/> health journey <br/> today.</h1>
